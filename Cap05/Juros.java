//Figura 5.6: Juros.java --> tradução da classe em ingles Interest.java
//Cáculo de juros compostos com for.
public class Juros 
{
    public static void main(String[] args)
    {
        double quantia; //quantia em depósito ao fim de cada ano
